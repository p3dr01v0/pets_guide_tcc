...
class TelaVerAgendaHotel extends StatefulWidget {
  final String typeService;
  final String nomeAgenda;

  const TelaVerAgendaHotel(
      {super.key, required this.typeService, required this.nomeAgenda});

  @override
  _TelaVerAgendaHotelState createState() => _TelaVerAgendaHotelState();
}

class _TelaVerAgendaHotelState extends State<TelaVerAgendaHotel> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text('Agendamentos Hotel: ${widget.nomeAgenda}'),
                            ...
                            itemBuilder: (context, index) {
                              ...
                              switch (statusNumber) {
                                case 1:
                                  ...
                                  break;
                                case 2:
                                  showStatus = 'Sob Cuidados';
                                  break;
                                case 3:
                                  showStatus =
                                      'Fim da estadia, Aguardando Check-Out';
                                  break;
