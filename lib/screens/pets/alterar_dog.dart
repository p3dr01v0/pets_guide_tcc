...
import 'package:flutter_application_1/screens/pets/dog.dart';
...
void alterarDog() async {
  ...
  if (novoNome.isNotEmpty &&
      novaRaca.isNotEmpty &&
      novaIdade.isNotEmpty &&
      novoPeso.isNotEmpty &&
      novasObservacoes.isNotEmpty) {
    ...
    if (userUid != null && mounted) {
      _firestore
        ...
        'tipo': 'Cachorro', // Adicionado o campo 'tipo' com valor 'cachorro'
      }).then((value) {
        ...
        Navigator.pushReplacement(
          ...
          MaterialPageRoute(builder: (context) => InfoCachorros()),
        );
      }).catchError((error) {
